...
class ReadingMaterialNotifier extends StateNotifier<List<ReadingMaterial>> {
  ReadingMaterialNotifier()
    : super([
        ReadingMaterial(
  ...
  ReadingMaterial? get selectedMaterial =>
      state.firstWhere((m) => m.storyId == selectedId);
}
