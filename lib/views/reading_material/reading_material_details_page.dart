...
class MobileReadingMaterialDetailsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MobileReadingMaterialDetailsPage> createState() =>
      _MobileReadingMaterialDetailsPageState();
}

class _MobileReadingMaterialDetailsPageState
    extends ConsumerState<MobileReadingMaterialDetailsPage> {
  @override
            ...
            onTap: () async {
              ...
              if (appointments == null) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Loading appointments...')),
                );
                return;
              }
              ...
              final hasTodayAppointment = appointments.any((a) {
              ...
              if (!hasTodayAppointment) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('No appointment for today')),
                );
                return;
              }
      ...
      loading:
          () => Center(
            child: Container(
              ...
              child: const Center(
                child: Image(
                  image: AssetImage('assets/splashscreen/LoadingBee.gif'),
                  width: 150,
                  height: 150,
                  gaplessPlayback: true,
                ),
  ...
  Future<dynamic> evaluationList(BuildContext context) {
    return showDialog(
      context: context,
      builder: (_) => const MobileEvaluationListDialog(),
    );
  }
}

class MobileEvaluationListDialog extends ConsumerWidget {
  const MobileEvaluationListDialog({super.key});
                                        ...
                                        : () {
                                          ...
                                          Navigator.push(
                                            ...
                                            PageAnimationTransition(
                                              page:
                                                  const MobileDigitalReadingPage(),
                                              pageAnimationType:
...
class TabletReadingMaterialDetailsPage extends ConsumerStatefulWidget {
  const TabletReadingMaterialDetailsPage({super.key});

  @override
  ConsumerState<TabletReadingMaterialDetailsPage> createState() =>
      _TabletReadingMaterialDetailsPageState();
}

class _TabletReadingMaterialDetailsPageState
    extends ConsumerState<TabletReadingMaterialDetailsPage> {
  @override
  Widget build(BuildContext context) {
    final storyAsync = ref.watch(storyProvider);
    final quizQuestionAsync = ref.watch(quizQuestionProvider);
  ...
  Future<dynamic> evaluationList(BuildContext context) {
    return showDialog(
      context: context,
      builder: (_) => const TabletEvaluationListDialog(),
    );
  }
}

class TabletEvaluationListDialog extends ConsumerWidget {
  const TabletEvaluationListDialog({super.key});
                                    ...
                                    state.selectedStudent == null
                                        ...
                                        : () {
                                          ...
                                          Navigator.push(
                                            ...
                                            PageAnimationTransition(
                                              page:
                                                  const TabletDigitalReadingPage(),
                                              pageAnimationType:
                                                  RightToLeftTransition(),
                                            ),
                                          );
